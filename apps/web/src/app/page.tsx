      ...
      <main className="flex flex-col gap-20 pb-20">
        ...
        <section id="faq" className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-3">
            {[
              {
                q: 'هل يمكنني تجربة المنصة واستكشاف أفكار SaaS مجاناً؟',
                a: 'نعم، المنصة تتيح لك التسجيل المجاني الكامل وتصفح عينات مشاريع SaaS والشركات الناجحة، بالإضافة لاستخدام محرك بناء نموذج العمل التجاري (BMC) ودراسة الأكاديمية بدون الحاجة لبطاقة ائتمان.'
              },
              {
                q: 'كيف يظهر الجدول في المعاينة وما الذي يفتحه تسجيل الدخول؟',
                a: 'يتم عرض الجدول الأصلي المستخدم داخل التطبيق بكافة خيارات التصفية والفرز لصفحات مشاريع الـ SaaS والـ Micro-SaaS كمعاينة، بينما يتطلب تصفح بقية الـ +500 شركة والوصول لصفحات التفاصيل الكاملة تسجيل حساب مجاني.'
              },
              {
                q: 'كيف تضمن المنصة سرية بيانات مشروعي ونموذج عملي؟',
                a: 'بياناتك ومشاريعك محمية بتقنيات Row Level Security (RLS) السحابية المتقدمة. لا يمكن لأي شخص آخر الاطلاع عليها إلا إذا قمت بنفسك بإنشاء رابط مشاركة خاص (Public Link).'
              },
              {
                q: 'هل تناسب المنصة مشاريع الـ SaaS والشركات التقنية فقط؟',
                a: 'تناسب المنصة كافة أنواع المشاريع: برمجيات SaaS، تطبيقات Micro-SaaS، المشاريع الخدمية، والتجارية، حيث نغطي أكثر من 100 قطاع استثماري مختلف.'
              }
            ].map((faq, idx) => {
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-4 sm:p-5 flex items-center justify-between text-right gap-4 hover:bg-muted/40 transition-colors"
                  >
