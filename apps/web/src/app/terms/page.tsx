        ...
        <div className="container mx-auto px-4 max-w-4xl space-y-8">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground max-w-xl mx-auto">
              تاريخ آخر تحديث: 9 أغسطس 2026 | اتفاوض وقواعد استخدام منصة خطة المعتمدة لدى بوابة Stripe.
            </p>
          </div>
          ...
          <Card className="border-border/70 shadow-xs">
            ...
            <CardContent className="p-6 space-y-6 text-sm text-foreground leading-relaxed">
              ...
              <section className="space-y-2 pt-4 border-t border-border/40">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
                  تتوفر المنصة عبر باقات متدرجة (رائد، مؤسس، قائد). يتم الدفع ومعالجة الفواتير بأمان من خلال بوابة الدفع المعرفية العالمية <strong>Stripe</strong>. تتجدد الاشتراكات دورياً وفق خيارك (شهري أو سنوي) ويمكنك إيقاف التجديد في أي وقت من لوحة حسابك.
                </p>
              </section>
