    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) data-[side=right]:w-(--sidebar-width) data-[side=left]:w-(--sidebar-width) max-w-[85vw] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        ...
        sideOffset={8}
        hidden={isMobile}
        className="pointer-events-none max-w-xs text-xs p-2.5 leading-relaxed shadow-md bg-popover text-popover-foreground border border-border/50 rounded-lg z-50"
        {...tooltip}
      />
    </Tooltip>
  )
