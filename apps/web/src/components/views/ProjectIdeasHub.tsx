...
export const ProjectIdeasHub: React.FC<ProjectIdeasHubProps> = ({ setActiveTab }) => {
  ...
  return (
    <div dir="rtl" className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:px-8 font-sans animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col gap-3 mb-10 text-center sm:text-right">
