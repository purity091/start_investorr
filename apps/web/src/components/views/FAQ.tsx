...
const faqs = [
  ...
  {
    question: 'كم تبلغ تكلفة الباقة الأولى وهل تتطلب وسيلة دفع؟',
    answer:
      'تبلغ تكلفة الباقة الأولى 99 ر.س شهرياً، بما يعادل 26.40 دولاراً، ويتم تفعيل الحساب بعد إكمال خطوات الدفع وإرفاق بيانات العملية عند الحاجة.',
  },
];
