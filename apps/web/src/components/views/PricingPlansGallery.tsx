...
export const PricingPlansGallery: React.FC = () => {
  ...
  const plans = [
    {
      ...
      features: [
        ...
        'بناء حتى 10 دراسات جدوى ونماذج عمل عبر باني المنصة',
  ...
  const comparisonFeatures = [
    ...
    { name: 'بناء دراسات الجدوى ونماذج العمل (BMC Builder)', free: 'حتى 10 دراسات', pro: 'غير محدود', enterprise: 'غير محدود' },
    { name: 'مشاركة الخطط ونماذج العمل (Sharing Links)', free: 'مغلق', pro: 'متاح بالكامل', enterprise: 'متاح بالكامل' },
