...
export interface GlobalFishProduction { year: number; volume: number; }
export interface MarketSegment { year: number; fishing: number; aquaculture: number; }
export interface RegionalProduction { name: string; value: number; }
