  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper flex min-h-svh w-full max-w-full min-w-0 overflow-x-hidden has-data-[variant=inset]:bg-sidebar",
          className
        )}
        {...props}
      >
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          !isRtl && "group-data-[side=right]:rotate-180",
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {props.children ? props.children : <PanelLeftIcon className="rtl:rotate-180" />}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex min-w-0 w-full max-w-full flex-1 flex-col bg-background overflow-x-hidden md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-start text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pe-8 rtl:group-has-data-[sidebar=menu-action]/menu-item:ps-8 rtl:group-has-data-[sidebar=menu-action]/menu-item:pe-2 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:bg-transparent data-active:font-semibold data-active:text-sidebar-foreground [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "mx-3.5 flex min-w-0 translate-x-px rtl:-translate-x-px flex-col gap-1 border-s border-sidebar-border px-2.5 py-0.5 group-data-[collapsible=icon]:hidden rtl:me-1 rtl:ms-3.5",
        className
      )}
      {...props}
    />
